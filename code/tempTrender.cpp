...
void tempTrender::tempOnDay(string cityFile, string cityName) {
		...
		unsigned short month = static_cast<unsigned short>(floatInput); // This turns a float into an unsigned short.
		...
		unsigned short day = static_cast<unsigned short>(dayInput);
